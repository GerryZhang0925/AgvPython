...
if not tf.test.gpu_device_name():
    warning.warn('No GPU found. Please use a GPU to train your neural network.')
else:
    print('Default GPU Device: {}'.format(tf.test.gpu_device_name()))

def load_vgg(sess, vgg_path):
    """
    Load Pretrained VGG16 Model into TensorFlow.
...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # Convolutional 1x1 to maintain space information
...
def optimize(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    :param num_classes: Number of classes to classify
    :return: Tupe of (logits, train_op, cross_entropy_loss)
    """
...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
    ...
    print('Staring training... for {} epochs'.format(epochs))
    print()
